    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            CreateMap<MemberEntity, MemberModel>()
                ...
                .ForMember(d => d.RoleID, map => map.MapFrom(s => s.RoleID))
                .ForMember(d => d.Role, map => map.MapFrom(s => s.Role.RoleName))
                .ForMember(d => d.RowVersion, map => map.MapFrom(s => s.RowVersion))
                .ReverseMap();
            ...
            CreateMap<BallotEntity, BallotModel>()
                ...
                .ForMember(d => d.VoteStartDate, map => map.MapFrom(s => s.VoteStartDate))
                .ForMember(d => d.VoteEndDate, map => map.MapFrom(s => s.VoteEndDate))
                .ForMember(d => d.PositionID, map => map.MapFrom(s => s.PositionID))
                .ForMember(d => d.RowVersion, map => map.MapFrom(s => s.RowVersion))
                .ReverseMap();
            ...
            CreateMap<ResultEntity, ResultModel>()
                .ForMember(d => d.ResultID, map => map.MapFrom(s => s.ResultID))
                .ForMember(d => d.VoteID, map => map.MapFrom(s => s.VoteID))
                .ForMember(d => d.MemberID, map => map.MapFrom(s => s.MemberID))
