#pragma checksum "G:\2020\Diego Project\V16\OSPI.Voting\Views\Elections\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "db24a4db909a99a8161fd8bcc11e05f30ed155aa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"db24a4db909a99a8161fd8bcc11e05f30ed155aa", @"/Views/Elections/Index.cshtml")]
            ...
            WriteLiteral(@"ata-countermax');
                ...
                if (secctionId.length >= parseInt(counterMin) && secctionId.length <= parseInt(counterMax)) {
                    $.each(secctionId, function () {
                        selectedCB.push('{""CandidateId"":""' + $(this).attr('data-cid') + '"",""MemberId"":""' + $(this).attr('data-cid') + '""}');
                    });
